...
4. *Survival analyses*  
   - Kaplan–Meier curves by SNF cluster  
...
- RNA ∩ Methylation = *135*  ← SNF integration cohort used for clustering  
- RNA ∩ Methylation ∩ Mutations = *116* (subset used for TMB/mutation summaries)  
...
- *Methylation (limma):*  
  - TNBC vs non-TNBC  
  - Differentially methylated probes (DMPs): adj.p < 0.05, Δβ > 0.2  
...
- *Similarity Network Fusion (SNF):*  
  - K = 6 (final consensus)  
  - Hyperparameters: K-neighbors = 20, α = 0.5, T = 20 iterations  
...
### Survival Analysis
- *Kaplan–Meier:* log-rank test across SNF clusters  
...
- SNF UMAP & Kaplan–Meier survival curves  
- Cox forest plots  
